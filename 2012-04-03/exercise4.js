...
//gambe
var chairLegs = SIMPLEX_GRID([REPLICA(2)([0.05,-0.4]),[0.05,-0.4,0.05],[0.45]]);
COLOR([0.545,0.27,0.05])(chairLegs);
// telaio
var beams1 = SIMPLEX_GRID([[0.5,-0.3],REPLICA(2)([0.05,-0.4]),[-0.45,0.02]]);
COLOR([0.545,0.27,0.05])(beams1);
var beams2 = T([0])([0.5])(R([2])([PI/2])(beams1));

//schienale
var backSit1 = SIMPLEX_GRID([[0.05,-0.3],REPLICA(2)([0.05,-0.4]),[-0.47,0.45]]);
COLOR([0.545,0.27,0.05])(backSit1);
var backSit2 = T([2])([0.57])(SIMPLEX_GRID([[0.05,-0.3],[0.5,-0.3],REPLICA(2)([0.02,-0.33])]));
COLOR([0.545,0.27,0.05])(backSit2);
var backSit3 = T([1,2])([0.1,0.12])(SIMPLEX_GRID([[0.05],REPLICA(6)([0.02,-0.05]),[-0.47,0.33]]));
COLOR([0.545,0.27,0.05])(backSit3);

//sedile
var chairSit1 = T([0,1])([0.055,0.05])(SIMPLEX_GRID([REPLICA(30)([-0.01,0.003]),[0.4],[-0.46,0.01]]));
COLOR([0.85,0.53,0.1])(chairSit1);
var chairSit2 = T([0,1])([0.052,0.05])(SIMPLEX_GRID([[0.4],REPLICA(30)([-0.01,0.003]),[-0.46,0.01]]));
COLOR([0.85,0.53,0.1])(chairSit2);

//sedia completa
var chair3D = T([0,1,2])([1.5,12,1])
	(S([0,1,2])([1.3,1.3,1.3])
		(STRUCT([chairLegs,beams1,beams2,backSit1,backSit2,backSit3,chairSit1,chairSit2])));


/**
* codice degli esercizi precedenti
*/
//pavimentazione
...
//colonne
var pillars3D = COLOR([0.51,0.51,0.45])(T([0,1])([26,6.8])(SIMPLEX_GRID
	([REPLICA(4)([0.15,-6.2]),[0.15,-7,0.15],[3,1]])));
...
// struttura completa con sedia
var pavillionBarcelona = STRUCT([floor3D,pools3D, walls3D,glassWalls3D,
	stairs3D,pillars3D,bench3D,roofs3D,chair3D]);
