...
var floor3D = STRUCT([floor1, floor2, floor3,floor4, floor5, floor6,floor7, floor8, floor9]);

// piscine
var bigPool3D = T([0,1])([1,1])(SIMPLEX_GRID([[20],[9],[0.8]]));
var smallPool3D = T([0,1])([47,5])(SIMPLEX_GRID([[4],[11],[0.8]]));
var pools3D = STRUCT([bigPool3D, smallPool3D]);
...
var walls3D = STRUCT([wall1, wall2, wall3, wall4, wall5, wall6, wall7, wall8, wall9, wall10]);

// mura di vetro

// bordo vetrata
var glassWall1AxisX = SIMPLEX_GRID([[0.1],REPLICA(2)([3]),[0.05]]);
var glassWall1AxisY = SIMPLEX_GRID([[0.1],REPLICA(2)([0.1,-2.7,0.1]),[3]]);
var glass1 = SIMPLEX_GRID([[0.01],[-0.1,2.7,-0.2,2.65],[-0.05,3,-0.5]]);
var glassWall1 =T([0,1,2])([31,7.5,1])(STRUCT([glassWall1AxisX,glassWall1AxisY,glass1]));
var glassWall2 =T([0])([1])(glassWall1);

var glassWall3AxisX = SIMPLEX_GRID([REPLICA(4)([0.1,-3.65]),[0.1],[2.8]]);
var glassWall3AxisY = SIMPLEX_GRID([REPLICA(3)([-0.1,3.65]),[0.1],[0.05]]);
var glass3 = SIMPLEX_GRID([REPLICA(3)([-0.1,3.65]),[0.01],[-0.05,2.7,0.05]]);
...
var glass4 = SIMPLEX_GRID([REPLICA(6)([-0.1,1.5]),[0.01],[-0.05,2.7,0.05]]);
...
var glass5 = SIMPLEX_GRID([[0.01],REPLICA(8)([-0.1,0.77]),[-0.05,2.7,0.05]]);
var glassWall5 = T([0,1,2])([44.6,6.9,1])(STRUCT([glassWall5AxisX,glassWall5AxisY,glass5]));

var glassWall6AxisX = SIMPLEX_GRID([REPLICA(4)([0.1,-1.85,0.05]),[0.1],[2.8]]);
var glassWall6AxisY = SIMPLEX_GRID([REPLICA(4)([1.99]),[0.1],[0.05]]);
var glass6 = SIMPLEX_GRID([REPLICA(4)([-0.1,1.89]),[0.01],[-0.05,2.7,0.05]]);
