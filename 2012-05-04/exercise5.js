...
/**
* Exercise 5
* Model a reasonably simplified airstrip, 
...
//prato
var grass = COLOR([0,0.25,0])(T([0,1,2])([-31,-60,0])(CUBOID([60,120,0.01])));

//asfalto
var asphalt = COLOR([0.4,0.4,0.4])( T([0,1,2])([-26,-60,0.01])(CUBOID([50,120,0.05])));

//linea a tratti
var lineAc = COLOR([1,1,1])(T([0,1,2])([0,-55,0.06])(SIMPLEX_GRID([[1],REPLICA(24)([3,-1]),[0.05]])));

//linee continue
var lineLR = COLOR([1,1,1])(T([0,1,2])([-26,-60,0.06])(SIMPLEX_GRID([REPLICA(2)([1,-48]),[120],[0.05]])));

//linee di fine pista
var finish_line =COLOR([1,1,1])(T([0,1,2])([-24,48,0.06])(SIMPLEX_GRID([REPLICA(12)([2,-2]),[11],[0.05]])));

//pista finale
var airstrip = STRUCT ([grass,lineAc,asphalt,lineLR,finish_line]);
DRAW (airstrip);
